...
export default function CaseWorkspace() {
  ...
  // Extract decision artifact from CaseData if it was fetched
  const decisionArtifact = caseData?.decision_artifact || null; 
  // Wait, `CaseService.get_case()` does not currently return DecisionArtifact Model in CanonicalCase!
  // I need to check `CanonicalCase` model to see if it includes decision_artifact.
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-500 mt-2 max-w-md mx-auto text-sm">
                    Evidence and decision are being evaluated.
                  </p>
                </div>
              </div>
            ) : (
